...
static FillerProc Fillers[32] = {
        &CValueUnpacker::zeroFill, &CValueUnpacker::return0,
        &CValueUnpacker::return0, &CValueUnpacker::linearFill,
        &CValueUnpacker::linearFill, &CValueUnpacker::linearFill,
        &CValueUnpacker::linearFill, &CValueUnpacker::linearFill,
        &CValueUnpacker::linearFill, &CValueUnpacker::linearFill,
        &CValueUnpacker::linearFill, &CValueUnpacker::linearFill,
        &CValueUnpacker::linearFill, &CValueUnpacker::linearFill,
        &CValueUnpacker::linearFill, &CValueUnpacker::linearFill,
        &CValueUnpacker::linearFill, &CValueUnpacker::k1_3bits,
...
inline void CValueUnpacker::_prepareBits(int bits)
{
...
int CValueUnpacker::_getBits(int bits)
{
    _prepareBits(bits);
    int res = _nextBits;
    _availBits -= bits;
...
int CValueUnpacker::getOneBlock(int *block)
{
    _blockPtr = block;
...
int CValueUnpacker::zeroFill(int pass, int /*ind*/)
{
...
int CValueUnpacker::linearFill(int pass, int ind)
{
    int mask = (1 << ind) - 1;
